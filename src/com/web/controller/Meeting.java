...
public class Meeting extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<MeetingBean> meetingBean = MeetingDao.getMeetingDetails();
	    request.setAttribute("meetingList", meetingBean);
	    RequestDispatcher rd = request.getRequestDispatcher("Meeting.jsp");
