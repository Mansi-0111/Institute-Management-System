			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Faculty Form</li>
					</ol>
				</div>
			</div>
		</div>
				...
				<div class="col-md-6" style="margin-left: 160px;">
					...
					<div class="card card-primary" style="border-radius:0;width:600px;">
						...
						<!-- form start -->
 						...
 						<form:form method="POST" action="savefaculty" modelAttribute="facultyregistration" autocomplete="off">
 						<div class="card-body">
 						<c:if test="${facultyregistration.user_master_Id gt 0}">
								<div class="form-group">
									<form:label path="user_master_Id">Faculty ID:</form:label>
			        				<form:input path="user_master_Id" cssClass="form-control" value="${facultyregistration.user_master_Id}" readonly="true"/>
								</div>
						</c:if>
								<div class="form-group">
									<form:label path="user_Fname">First-Name:<span class="required"></span></form:label>
			       					<form:input path="user_Fname" cssClass="form-control" required="required" id="name" onkeyup="checkdataname('name',this.value);" value="${facultyregistration.user_Fname}"  disabled="${facultyregistration.user_master_Id gt 0}"/>
								...
								<div class="form-group">
			        				...
			        				<form:input path="user_Lname" cssClass="form-control" required="required" id="lname" onkeyup="checkdataname('lname',this.value);" value="${facultyregistration.user_Lname}" disabled="${facultyregistration.user_master_Id gt 0}" />
								...
								<div class="form-group">
			        				...
			        				<form:textarea path="user_Address" cssClass="form-control" required="required" id="address" onkeyup="checkdataaddress('address',this.value);" value="${facultyregistration.user_Address}" />
								...
								<div class="form-group">
									 <form:label path="user_Contact">Contact:<span class="required"></span></form:label>
			       					 <form:input path="user_Contact" cssClass="form-control" required="required" id="contact" onkeyup="checkdatacontact('contact',this.value);" value="${facultyregistration.user_Contact}"/>
								...
								<div class="form-group">
			        				...
			        				<form:input path="user_Email" cssClass="form-control" required="required" id="email" onkeyup="checkdataemail('email',this.value);" value="${facultyregistration.user_Email}" disabled="${facultyregistration.user_master_Id gt 0}"/>  
								...
								<div class="form-group">
			        				...
			        				<form:input path="user_Dob" type="date" cssClass="form-control" required="required" value="${facultyregistration.user_Dob}"/>
								</div>
								<div class="form-group">
									<form:label path="user_Qualification">Qualification:<span class="required"></span></form:label>
			        				<form:input path="user_Qualification" cssClass="form-control" required="required" value="${facultyregistration.user_Qualification}"/>
								</div>
								<div class="form-group">
									 <form:label path="user_Password">Password:<span class="required"></span></form:label>
			        				 <form:password path="user_Password" cssClass="form-control" required="required" id="password" onkeyup="checkdatapassword('password',this.value);" value="${facultyregistration.user_Password}"/>  
