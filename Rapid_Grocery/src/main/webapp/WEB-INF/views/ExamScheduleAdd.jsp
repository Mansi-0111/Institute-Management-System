			...
			<div class="row mb-2">
				...
				<div class="col-sm-6">
					<ol class="breadcrumb float-sm-right">
						...
						<li class="breadcrumb-item active">Exam-Schedule Form</li>
					</ol>
				</div>
			</div>
		</div>
				...
				<div class="col-md-6" style="margin-left: 160px;">
					...
					<div class="card card-primary" style="border-radius:0; width:600px;">
						...
						<!-- form start -->
 						...
 						<form:form method="POST" action="saveexamschedule" modelAttribute="examschedule" autocomplete="off">
 						<div class="card-body">
								
								<div class="form-group">
									<form:label path="examschedule_Date">Date:<span class="required"></span></form:label>
			       					<form:input path="examschedule_Date" id="examschedule_Date" required="required" type="date" cssClass="form-control" value="${examschedule.examschedule_Date}"/>
								</div>
								<div class="form-group">
