...
<div class="container-fluid page-header" style="margin-bottom: 90px;height:250px;">
	<div class="container">
		<div class="d-flex flex-column justify-content-center"
			...
			<h3 class="display-4 text-white text-uppercase">HTML/CSS/JAVASCRIPT</h3>
			<div class="d-inline-flex text-white">
				<p class="m-0 text-uppercase">
					<a class="text-white" href="index.jsp">Home</a>
				</p>
				<i class="fa fa-angle-double-right pt-1 px-3"></i>
				<p class="m-0 text-uppercase">Html/css/javascript</p>
			</div>
		</div>
	</div>
</div>
                ...
                <div class="row" style="padding-left: 120px;height: 930px;padding-top:30px;">
                    ...
                    <div class="col-lg-10">
                        ...
                        <div class="course-content p-6 bg-white ">
                            ...
                            <center><h2 class="h1" style="color: #223a66; font-size:30px;">About <span class="h1" style="font-size:30px;">HTML/CSS/JavaScript course</span></h2></center>
							
                            <div style="margin-top:35px;margin-bottom:-22px;">
							<p class="mb-2">HTML is the basic language that is used to create a website. The full form of HTML is Hyper Text Markup Language. It is the basic Markup language that you will be mandatorily learning in order to unveil the world of website development. Whenever you want to post text, photos or videos on your website, you need to know this language so that you can ensure that you have done it correctly.</p>
							</div>
                            ...
                            <div class="course-module" >
                                ...
                                <div id="abc">
                                    ...
                                    <div id="c-programming" class="course-description pt-2">
                                        ...
                                        <h4 class="alert-dark p-2  fs-16 rounded ps-3" data-bs-toggle="collapse"  data-bs-target="#collapseOne" style="background-color: #f2f1f8;font-size:20px;">HTML and CSS Syllabus</h4>

                                        <div class="ps-3">

                                            <ul class="course-points"> 
 												<li> Introduction Of HTML 5 &  Browser. </li>

                                                <li> Form Design. </li>

                                                <li> Audio &  Video, Canvas &  SVG Tag. </li>

                                                <li> API, CANONICAL, Meta &  OG Meta. </li>

                                                <li> CSS &  CSS3 All Over Properties. </li>

                                                <li> CSS Selectors. </li>

                                                <li> Media Query (Responsive Site). </li>

                                                <li> creation Web Theme Using Less &  Sass. </li>
                                        ...
                                        <h4 class="alert-dark p-2  fs-16 rounded ps-3" data-bs-toggle="collapse"  data-bs-target="#collapseOne" style="background-color: #f2f1f8;font-size:20px;">JavaScript Syllabus</h4>
