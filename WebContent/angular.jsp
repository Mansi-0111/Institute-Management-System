...
<div class="container-fluid page-header" style="margin-bottom: 90px;height:250px;">
	<div class="container">
		<div class="d-flex flex-column justify-content-center"
			...
			<h3 class="display-4 text-white text-uppercase">Angular js</h3>
			<div class="d-inline-flex text-white">
				<p class="m-0 text-uppercase">
					<a class="text-white" href="index.jsp">Home</a>
				</p>
				<i class="fa fa-angle-double-right pt-1 px-3"></i>
				<p class="m-0 text-uppercase">angular js</p>
			</div>
		</div>
	</div>
</div>
...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1"%>
        ...
        <form action="onlinePayment" method="post" id="paymentOnline">
        	<input type="hidden" name="amount" id="amountId" value="7500">
            ...
            <div class="col-md-8 shadow-lg p-3 mb-5 bg-light rounded border   my-2" style="color:black;margin-left: 240px;">
                ...
                <div class="row" style="padding-left: 120px;height: 890px;padding-top:30px;">

                    <div class="col-lg-10">

                        <div class="course-content p-6 bg-white ">

                            <center><h2 class="h1" style="color: #223a66;">About <span class="h1">Angular JS course</span></h2></center>
							
                            <div style="margin-top:35px;margin-bottom:-22px;">
							<p class="mb-0">AngularJS is a JavaScript-based open-source front-end web framework for developing single-page applications. It is maintained mainly by Google and a community of individuals and corporations.</p>
							</div>
                            ...
                            <div class="course-module" >
                                ...
                                <div id="abc">
                                    ...
                                    <div id="c-programming" class="course-description pt-2">
                                        ...
                                        <h4 class="alert-dark p-2  fs-16 rounded ps-3" data-bs-toggle="collapse"  data-bs-target="#collapseOne" style="background-color: #f2f1f8;font-size:20px;">Angular JS Syllabus</h4>
                                        ...
                                        <div class="ps-3">
                                            ...
                                            <ul class="course-points"> 
                                             ...
                                             <ul class="course-points">
                                                ...
                                                <li class="ps-3">Personality Development</li>

                                                <li class="ps-3">Entrepreneur & Freelancing</li> 
                                        ...
                                        <% } else {%>
                                            ...
                                            <button class="btn btn-primary btn-sm mt-4"  href="#" style="padding: 7px;width:110px;font-size: 17px;" onclick="makePayment();">Make Payment</button>
                                        <% }%>
